...
import com.proj.team.board.service.ReplyService;
...
public class BoardController {
	...
	//댓글은 게시물에 종속되어 있기 때문에 따로 컨트롤로러를 만들지 않았습니다.
	...
	public void fileDown(@RequestParam Map<String, Object> map, HttpServletResponse response) throws Exception{
		...
		byte fileByte[] = org.apache.commons.io.FileUtils.readFileToByteArray(new File("C:\\workplace\\file\\"+storedFileName));
